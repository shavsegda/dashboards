...
_BOT_URL_WANTED = {
    ...
    # Добавлено 07.08.2026 спекой 006: три новые страницы замера — полгода и год.
    "STATE_FINWELL_MINI_APP_URL", "STATE_HEALTH_MINI_APP_URL",
    "PAIR_FACES_MINI_APP_URL", "CARDS_NEW_ON_PAGE", "CARDS_ON_PAGE",
}
