...
# Три страницы полугодового и годового ритма (спека 006 бота). Тема Телеграма,
# безопасные зоны и стабильная высота у них те же — правила общие для всех
# мини-аппов, и новая страница не исключение.
LONG: Tuple[str, ...] = (
...
PAGES: Tuple[str, ...] = (DAY,) + FORMS + NEW + LONG
