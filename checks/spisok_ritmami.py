...
# Первый экран в пяти состояниях. Хеши снятЫ 10.08.2026 ДО правки списка: правка
# ритмов касалась только того, что ниже «Посмотреть всё».
#
# ПЕРЕСНЯТЫ 10.08.2026, спека 020, История 4. Первый экран изменился СОЗНАТЕЛЬНО:
# ниже просьбы встал блок про замер, на который бот не приглашает. Владелец не
# нашёл «Спокойствие с деньгами» — бот про деньги не спрашивает сам, и до таких
# замеров невозможно было дойти.
#
# Это не ослабление проверки. Хеш остаётся, просто снят после решения, а не до:
# любое НЕЗАПЛАНИРОВАННОЕ движение экрана он ловит по-прежнему. Состав экрана
# отдельно проверяется словами ниже, а сам блок — `zamer_bez_priglasheniya.py`.
#
...
FIRST_SCREEN_SHA: Dict[str, str] = {
    "quiet":
        "a5c31cde972d370caf1c21478ae3879c9f345c24ddcfe261ed498ded5e972551",
    "obs_ask":
        "a9f816b78b1f81047922a340f72b2c07dc4166e5dcdd9318bb7b8035df544e5b",
    "obs_only":
        "88d6947a34b96e8ddaf0803ef115d537e1b5f177062b1ce0e9cc42b304f5e82c",
    "first_step":
        "b5bd325c33d087b68ef91e9f1dc50695a08590d029b33c5f4f6a987c3674419f",
    "with_blind":
        "c856ff11646fec559ea85e9b8052d1309776ce3094dec0a13ef649e7f2c72b0b",
}
